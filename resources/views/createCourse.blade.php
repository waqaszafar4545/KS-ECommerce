        ...
        <div class="row pd-box">
            ...
            <div class="col-6 pd-form-left-sec">
                <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="title" id="title" aria-describedby="couretitle" placeholder="Enter Title">
                </div>
                <br>
                <div class="row">
                    <div class="col-12">
